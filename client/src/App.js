...
class App extends Component {
  ...
  handleChange(event) {
    if (event.target.value === "capricorn") {
      this.setState({sign: "spotify:playlist:4HyxpsaW5iDa0oErG5J4qG"}); //Capricorn 
    } else if (event.target.value === "Tarus") {
      this.setState({sign: "spotify:playlist:2Fxc3755XB32GQBTtosPl6"}); //Tarus
    } else if (event.target.value === "Gemini") {
      this.setState({sign: "spotify:playlist:4yJL15i80GrTSaflJXFaAr"}); //Gemini
    } else if (event.target.value === "Leo") {
      this.setState({sign: "spotify:playlist:37i9dQZF1DXd1BPICjimv2"}); //Leo
    } else if (event.target.value === "Cancer") {
      this.setState({sign: "spotify:playlist:6DzXTwliVgw9wpxETX27xR"}); //Cancer
    } else if (event.target.value === "Virgo") {
      this.setState({sign: "spotify:playlist:3aPDfecmMMTQGSZ0cE61bC"}); //Virgo
    } else if (event.target.value === "Libra") {
      this.setState({sign: "spotify:playlist:7liW6NkwgAwFxm5EcMbwdw"}); //Libra
    } else if (event.target.value === "Sagittarius") {
      this.setState({sign: "spotify:playlist:79Wb8amvhh69cOUy1w2oAV"}); //Sagittarius
    } else if (event.target.value === "Capricorn") {
      this.setState({sign: "spotify:playlist:4HyxpsaW5iDa0oErG5J4qG"}); //Capricorn
    } else if (event.target.value === "Scopio") {
      this.setState({sign: "spotify:playlist:4Wz7H3L5x0xR9rnp9c4p0W"}); //Scopio
    }  else if (event.target.value === "Aquarius") {
      this.setState({sign: "spotify:playlist:3vC3vVfxrKVZTbt9ZouyiK"}); //Aquarius
    }      else { 
      this.setState({sign: "spotify:playlist:6USjf7kMDtwuYxh0JQfdYU"}); //Pisces
    }
  }
